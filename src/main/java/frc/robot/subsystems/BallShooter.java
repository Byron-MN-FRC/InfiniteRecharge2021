...
limitSwitchDown = new DigitalInput(0);
 addChild("limitSwitchDown",limitSwitchDown);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        LimelightUtility.EnableDriverCamera(false); // moved from initDefaultCommand
    }
    ...
    public void stopBelt() {
        RobotContainer.getInstance().getm_ballIndexer().getBeltMotor().set(0);
