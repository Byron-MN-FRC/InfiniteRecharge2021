...
public class LimeLightTurn extends CommandBase {
    ...
    public LimeLightTurn(DriveTrain subsystem) {
    ...
    public void execute() {
        ...
        if (targetAcquired) {
            ...
            RobotContainer.getInstance().m_driveTrain.closedLoopTurn(targetTurn);
        }
        ledWarmUp--;
    }
    ...
    public boolean isFinished() {
        boolean turnComplete = RobotContainer.getInstance().m_driveTrain.closedLoopTurnComplete(targetTurn);
